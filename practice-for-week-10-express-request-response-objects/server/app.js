...
app.get("/viewers/:viewerId", (req, res) => {

    res.status(200).json(
        {
            "id": req.params.viewerId,
            "firstName": "Marian",
            "lastName": "Eu",
            "birthDate": "08/08/1999",
            "favoriteMovies": ["one", "two", "three"]
...
app.get("/info", (req, res) => {
    if (req.query.message !== "" && req.query.message !== undefined && req.query.message !== null) {
